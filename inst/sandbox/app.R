    ...
    shiny::fluidRow(
      shiny::column(6,
        ...
        shiny::textAreaInput(
          ...
          rows = 12,
          width = "100%",
          placeholder = "A request that a user could make of an LLM. This should be something that's quite hard for e.g. an instance of `ellmer::chat_anthropic(model = "claude-3-7-sonnet-latest")` with no system prompt."
        ),
        shiny::textAreaInput(
          "target",
          "Target",
